        ...
        <footer class="bg-gray-900 josefin-sans-regular text-white py-8 pt-12  ">
            <div class="container mx-auto px-4 md:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a class="hover:text-indigo-500 cursor-pointer" onClick={() => navigate('/scriptures/Vedas')}>
                                Vedas
                            </a>
                        </li>
                        <li>
                            <a class="hover:text-indigo-500 cursor-pointer" onClick={() => navigate('/scriptures/Upanishad')} >
                                Upanishads
                            </a>
                        </li>
                        <li>
                            <a class="hover:text-indigo-500 cursor-pointer" onClick={() => navigate('/scriptures/BhagvadGeeta')} >
                                Bhagavad Gita
                            </a>
                        </li>

                        <li>
                            <a class="hover:text-indigo-500 cursor-pointer" onClick={() => navigate('/scriptures/Epics')}>
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a class="hover:text-indigo-500 cursor-pointer" onClick={() => navigate('/about')}>
                                About
                            </a>
                        </li>
                        <li>
                            <a class="hover:text-indigo-500 cursor-pointer" onClick={() => navigate('')}>
                                Contact
                            </a>
                        </li>
                        <li>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-4">
                        <a class="text-gray-400 hover:text-indigo-500 cursor-pointer" onClick={() => navigate('')}>
                            <svg
