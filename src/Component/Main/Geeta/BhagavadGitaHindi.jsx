    ...
    <div className='bg-orange-300 min-h-screen'>
      <div className="w-full max-w-7xl mx-auto py-4 pb-14 lg:py-12 px-4 md:px-6">
        ...
        <div className="my-8 martel-sans-black  p-4 mb-20 bg-orange-400 shadow-lg rounded-md">
          {selectedCommentary === 'Shankaracharya' && shloka?.Shankaracharya && <p>{shloka.Shankaracharya.English}</p>}
          {selectedCommentary === 'Ramanujacharya' && shloka?.Ramanujacharya && <p>{shloka.Ramanujacharya.English}</p>}
