  ...
  return (
    <div className="bg-orange-300 min-h-screen flex flex-col items-center">
      <div className="bg-orange-100 w-full p-2 lg:p-2 lg:px-8 flex items-center gap-3 justify-center">
        <div className="flex items-center space-x-2  overflow-x-auto" style={styles.scrollbar}>
      ...
      <div className="bg-orange-100 w-full p-4 lg:px-20 flex justify-between fixed bottom-0 left-0">
        ...
        <button
          onClick={handleNext}
          className={`inline-flex items-center w-[120px] justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 ${selectedChapter !== chapters.length ? 'bg-[#a0522d] text-white' : 'bg-[#a0522d] text-white pointer-events-none opacity-50'}`}
        >
          Next
        </button>
      </div>
