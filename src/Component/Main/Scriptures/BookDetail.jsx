        ...
        <div class="flex-1 space-y-4 text-start md:text-left">
          ...
          <div class="flex justify-center  lg:justify-start  gap-4">
            ...
            <button
              ...
              className="inline-flex gap-3 items-center border-gray-400 justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-11 rounded-md px-8"
            >
              <svg
