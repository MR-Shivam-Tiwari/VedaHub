...
import Data from "./JsonDataa/RamayanHindi.json";
import { useLocation, useNavigate } from "react-router-dom";

function RamayanaHindi() {
  ...
  const formatDescription = (text) => {
    ...
    formattedDescription = formattedDescription?.replace(
      /'([^']*)'/g,
      ' </br><b style="color: gray; ">$1</b>'
    );

    formattedDescription = formattedDescription?.replace(
      /`([^`]*)`/g,
      ' </br> </br><i style="color: #c2410c; font-weight: bold; font-size:25px;">$1</i>  '
    );
